...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20251024_bbacasacincotta_2084b61c9bdb09db5859_20251025065037_archive.zip';
        const ARCHIVE_SIZE       = '38263438';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '2084b61-25065037';
        const SECONDARY_PACKAGE_HASH = 'b39810d-25065037';
